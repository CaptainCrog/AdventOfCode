...
public static class Menu2016
{
    ...
    static readonly string _basePath = @"..\..\..\..\AdventOfCode2016\Inputs\Puzzles";
                ...
                if (int.TryParse(choiceRaw, out var choiceSanitised))
                {
                    ...
                    switch (choiceSanitised)
                    {
                        ...
                        case 3:
                            ...
                            break;
                        case 4:
                            _ = new Day04(@$"{_basePath}\Day04Puzzle.txt", "northpole");
                            break;
                        case 5:
                        ...
                        case 7:
                            ...
                            break;
                        case 8:
                            _ = new Day08(@$"{_basePath}\Day08Puzzle.txt", 6, 50);
                            break;
                        case 9:
                            _ = new Day09(@$"{_basePath}\Day09Puzzle.txt");
                            break;
                        case 10:
                            _ = new Day10(@$"{_basePath}\Day10Puzzle.txt", (61, 17));
                            break;
                        case 11:
                        ...
                        case 12:
                            ...
                            break;
                        case 13:
                            _ = new Day13(@$"{_basePath}\Day13Puzzle.txt", new Point() { X = 31, Y = 39 });
                            break;
                        case 14:
                        ...
                        case 15:
                            ...
                            break;
                        case 16:
                            _ = new Day16(@$"{_basePath}\Day16Puzzle.txt", 272);
                            break;
                        case 17:
                            _ = new Day17(@$"{_basePath}\Day17Puzzle.txt");
                            break;
                        case 18:
                            _ = new Day18(@$"{_basePath}\Day18Puzzle.txt", 40);
                            break;
                        case 19:
                            _ = new Day19(@$"{_basePath}\Day19Puzzle.txt");
                            break;
                        case 20:
                            _ = new Day20(@$"{_basePath}\Day20Puzzle.txt", uint.MaxValue);
                            break;
                        case 21:
                            _ = new Day21(@$"{_basePath}\Day21Puzzle.txt", "abcdefgh", "fbgdceah");
                            break;
                        case 22:
                            _ = new Day22(@$"{_basePath}\Day22Puzzle.txt");
                            break;
                        case 23:
                            _ = new Day23(@$"{_basePath}\Day23Puzzle.txt", 7);
                            break;
                        case 24:
