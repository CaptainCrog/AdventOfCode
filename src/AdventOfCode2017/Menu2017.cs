                ...
                if (int.TryParse(choiceRaw, out var choiceSanitised))
                {
                    ...
                    switch (choiceSanitised)
                    {
                        ...
                        case 22:
                            ...
                            break;
                        case 23:
                            _ = new Day23(@"..\..\..\..\AdventOfCode2017\Inputs\Puzzles\Day23Puzzle.txt");
                            break;
                        case 24:
                            _ = new Day24(@"..\..\..\..\AdventOfCode2017\Inputs\Puzzles\Day24Puzzle.txt");
                            break;
                        case 25:
                            _ = new Day25(@"..\..\..\..\AdventOfCode2017\Inputs\Puzzles\Day25Puzzle.txt");
                            break;
                        default:
