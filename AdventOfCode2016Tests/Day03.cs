namespace AdventOfCode2016Tests
{
    ...
    public class Day03
    {
        ...
        {
            var instance = new AdventOfCode2016.Problems.Day03("Day3Test1.txt");
        ...
        {
            var instance = new AdventOfCode2016.Problems.Day03("Day3Test2.txt");
            instance.FirstResult.Should().Be(0);
        }
        [TestMethod]
        ...
        {
            var instance = new AdventOfCode2016.Problems.Day03("Day3Test3.txt");
        ...
        {
            var instance = new AdventOfCode2016.Problems.Day03("Day3Test4.txt");
            instance.FirstResult.Should().Be(1);
        }
        [TestMethod]
        [DeploymentItem("Inputs/Day03/Day3Test5.txt")]
        public void Part1_OutputsCorrectTriangleCountFile5_IsTrue()
        {
            var instance = new AdventOfCode2016.Problems.Day03("Day3Test5.txt");
            instance.FirstResult.Should().Be(1);
        }
        [TestMethod]
        [DeploymentItem("Inputs/Day03/Day3Test6.txt")]
        public void Part2_OutputsCorrectTriangleCountFile6_IsTrue()
        {
            var instance = new AdventOfCode2016.Problems.Day03("Day3Test6.txt");
